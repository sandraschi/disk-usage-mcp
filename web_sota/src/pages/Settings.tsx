    ...
    <div className="space-y-6" data-testid="settings-page">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 space-y-3" data-testid="llm-onboarding">
        ...
        {active && models.length > 0 && (
          <div className="flex items-center gap-2">
            <label htmlFor="llm-model" className="text-sm text-zinc-300">
              Model:
            </label>
            <select
              id="llm-model"
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 space-y-2" data-testid="settings-tools">
        ...
        <ul className="text-sm text-zinc-400 space-y-1">
          <li>
            <strong className="text-zinc-200">dua-cli</strong> - Fast disk usage analyzer (Rust)
          </li>
          <li>
            <strong className="text-zinc-200">czkawka_cli</strong> - Duplicate file detector (Rust)
          </li>
          <li>
            <strong className="text-zinc-200">FastMCP 3.4</strong> - MCP protocol server
          </li>
          <li>
            <strong className="text-zinc-200">FastAPI</strong> - REST backend + Swagger docs
          </li>
        </ul>
      </div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 space-y-2" data-testid="settings-ports">
        ...
        <p className="text-sm text-zinc-400">
          REST API: <code className="text-amber-400 bg-zinc-800 px-1.5 py-0.5 rounded">11114</code>
        </p>
        <p className="text-sm text-zinc-400">
          Frontend dev: <code className="text-amber-400 bg-zinc-800 px-1.5 py-0.5 rounded">11115</code>
        </p>
      </div>
    </div>
  );
