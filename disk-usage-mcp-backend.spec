...
a = Analysis(
    ...
    datas=[('src/disk_usage_mcp', 'disk_usage_mcp')],
    hiddenimports=[
...
pyz = PYZ(a.pure)
exe = EXE(pyz, a.scripts, a.binaries, a.zipfiles, a.datas, name='disk-usage-mcp-backend', debug=False, strip=False, upx=False, upx_exclude=[], runtime_tmpdir=None, console=False)
